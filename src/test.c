...
_Bool TestSuite_AddTestCase(PTESTSUITE pTestSuite, char const *pszName,
                            TEST_ROUTINE pTestFn, void *pUserData) {
...
void TestSuite_Run(PTESTSUITE pTestSuite) {
    ...
    for (PTESTCASE pCurrentTestCase = pTestSuite->pTestCases; pCurrentTestCase;
